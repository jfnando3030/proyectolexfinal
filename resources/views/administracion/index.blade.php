          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a data-toggle="pill" href="#menu1"><i class="fa fa-inbox"></i> Todos
                  <span class="label label-primary pull-right">12</span></a></li>
                <li><a data-toggle="pill" href="#menu2"><i class="fa fa-clock-o"></i> En curso</a></li>
                <li><a data-toggle="pill" href="#menu3"><i class="fa fa-ban"></i> Finalizados</a></li>
                <li><a data-toggle="pill" href="#menu4"><i class="fa fa-file-text"></i> Nuevos <span class="label label-warning pull-right">65</span></a>
                </li>
