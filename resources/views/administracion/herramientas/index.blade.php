...
<div align="center" class="col-md-12 col-12 col-xs-12 col-lg-12 col-sm-12" style="padding-top:15px; padding-bottom: 10px">
        <h4 style="color: black; text-align:center; font-size:25px;">Mis herramientas </h4>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
                    ...
                    <div class="statistic__item">
                        ...
                        <div class="icon">
                            ...
                            <div class="col-md-12 col-lg-12" align="center">
                                <a href="{{route('herramientas.create')}}"><button title="Añadir nuevo registro" id="payment-button" type="submit" class="btn btn-lg btn-info">
      ...
      {!! Form::open(['route' => ['herramientas.destroy', ':USER_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
        {!! Form::close() !!}
