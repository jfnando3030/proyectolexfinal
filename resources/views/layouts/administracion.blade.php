            ...
            <div class="menu-sidebar2__content js-scrollbar1 shadow">
                ...
                <nav class="navbar-sidebar2" style="    padding-bottom: 50px; " >
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{url('administracion/mired')}}" onclick="return myFunction();" id="menu_letras">
                            <i class="fa fa-share-alt"></i>Mi red</a>
                        </li>

                        

                        <li>
                            <a href="{{ url('administracion/invita/bango') }}" onclick="return myFunction();" id="menu_letras">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="btn-group-sm d-none" id="mini-fab">
                      <a href="{{route('herramientas.index')}}" onclick="return myFunction();" class="btn btn-info btn-fab" data-container="body" data-toggle="tooltip" data-placement="left" data-original-title="Herramientas" title="Mis herramientas" id="autre">
                      ...
                      <a href="{{url('administracion/mired')}}" onclick="return myFunction();" class="btn btn-warning btn-fab" data-container="body" data-toggle="tooltip" data-placement="left" data-original-title="SMS" title="Mi Red" id="sms">
                        <i class="material-icons">
                      ...
                      <a href="{{ url('administracion/invita/bango') }}" onclick="return myFunction();" class="btn btn-danger btn-fab" data-container="body" data-toggle="tooltip" data-placement="left" data-original-title="Mail" title="Invita Genta a Bango" id="mail">
                        <i class="material-icons">
