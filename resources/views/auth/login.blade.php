...
<html lang="en">
  <head>
    ...
    <title>Bango Energy Gel - Login</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="user_card">
                    <div class="d-flex justify-content-center">
                        <div class="brand_logo_container">
                            <a href="#" onclick="return myFunction();" title="Ir al inicio">  <img src="{{url('frontend/images/redondo.png')}}" class="brand_logo" alt="Logo"> </a>
                        </div> 
                    </div>
                    ...
                    <div class="mt-2">
                        <div class="d-flex justify-content-center links">
                           ¿No tienes una cuenta? <a style="font-weight: bold;" href="{{ route('register') }}" onclick="return myFunction();" class="ml-2">Regístrate</a>
                        </div>
                        <div class="d-flex justify-content-center links">
                                <a style="font-weight: bold;" href="#" onclick="return myFunction();">
