                    ...
                    <div class="d-flex justify-content-center form_container">
                        ...
                        <form style="width: 90%;" class="form-horizontal" method="POST" action="{{ route('password.email') }}">
                          ...
                          <div  class="input-group mb-3{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <input oninvalid="this.setCustomValidity('Se requiere que ingrese su email')" placeholder="Ingrese su Email" oninput="this.setCustomValidity('')"  id="email" type="email" class="form-control" name="email"  value="{{ old('email') }}" required autofocus>
