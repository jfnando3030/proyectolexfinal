                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="row">
                                        <div class="col-md-6" style="padding-bottom: 15px;">
                                            ...
                                            <input placeholder="Ingrese el nombre de la tarifa" class="form-control" required="required" onkeypress="return soloLetras(event)" name="tarifa" type="text">
                                        </div>
                                        <div class="col-md-6" style="padding-bottom: 15px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="padding-bottom: 15px;">
                                            ...
                                            <textarea placeholder="Ingrese la descripción breve de la tarifa" class="form-control" required="required" onkeypress="return soloLetras(event)" name="descripcion" rows="7"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
